...
export const PainScene: React.FC<AgencyAgentsProps> = ({
  backgroundColor,
  textColor,
  accentColor,
  warningColor,
        ...
        <div style={{ opacity: terminalOpacity, marginBottom: 22 }}>
          ...
          >
            ...
            >
              ...
              <span style={{ fontSize: 12, color: "#555", marginLeft: 8 }}>ai-chat.log</span>
            </div>
