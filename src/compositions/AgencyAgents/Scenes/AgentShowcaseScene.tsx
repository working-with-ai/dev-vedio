...
import { fadeInUp, fadeIn, nodeReveal, pulseGlow, staggerDelay, cardSlideIn } from "../animations";
...
export const AgentShowcaseScene: React.FC<AgencyAgentsProps> = ({
  ...
  return (
    ...
    >
      <div style={{ position: "absolute", inset: 0, background: `radial-gradient(ellipse at 60% 40%, ${highlightColor}0c 0%, transparent 50%)` }} />
